const char* mqtt_server             = "fe37d981604e442c856799038ddf9db1.s1.eu.hivemq.cloud";
const char* mqtt_user               = "rabbithole";
const char* mqtt_pass               = "vyb8xfc_TKN*twg4kja";
const char* mqtt_id                   = "thermal_printer";
const unsigned int mqtt_port        = 8883;
const unsigned int baud             = 9600;

const uint32_t papercheck_milliseconds= 10000L; 

const char* mqtt_listen_topic_text2print     = "order/drinks";
// since Version 2
